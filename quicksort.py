...
def quicksort(list, start, end, comparison_function):
    ...
    for i in range(start, end):
        ...
        if comparison_function(list[i], pivot_elemment):
    ...
    quicksort(list, start, lesser_than_pointer - 1, comparison_function)
    quicksort(list, lesser_than_pointer + 1, end, comparison_function)
